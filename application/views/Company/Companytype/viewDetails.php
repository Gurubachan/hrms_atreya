            ...
            <div class="">
                <div class="col-12">
                    <table class="table-bordered">
                        ...
                        <tr class="">
                            <td class="" style="width: 300px;">Company type Id:</td>
                            <td class=""><?php echo $r->id?></td>
                        </tr>
                        <tr class="">
                            <td class="">Company type name:</td>
                            <td class=""><?php echo $r->typename?></td>
                        </tr>
                        <tr class="">
                            <td class="">Company type Short Name:</td>
