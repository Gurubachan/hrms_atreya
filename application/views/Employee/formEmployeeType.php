...
?>
                ...
                <div class="box-content">
                    <form  class="" id="employeeTypeForm" autocomplete="off">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="employeeTypeShortname" name="employeeTypeShortname" class="form-control" aria-required="true" aria-invalid="false" onclick="charachters_validate('employeeTypeShortname')" minlength="2" maxlength="5" required placeholder="Enter shortname">
                            <small class="errormsg_employeeTypeShortname"></small>
                        </div>
                        <br>
    ...
    <div class="row" style="display: none;" id="toggle_employee_type">
        <div class="box col-md-12">
            <div class="box-inner">
                <div class="box-header well">
