             ...
             success:function(data){
                 ...
                 if(data!=false){
                     ...
                     for(var i=0; i<z; i++){
                         ...
                         html +=("<tr> <td>"+j+"</td><td>"+ jsondata[i].gendername+"</td><td>"+isactive+"</td><td><button class='btn editBtn btn-sm' onclick='reportEditGender(" +checkId+ "," +strgender+ "," +editisactive+ ")'>Edit</button></td></tr>");
                     }
