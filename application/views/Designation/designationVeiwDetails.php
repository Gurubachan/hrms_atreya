...
if($result!=false){
    foreach ($result as $r) {
        ...
        if($r->designationshortname ==""){
            $shortname = "<span style='color:red'>No Updated Yet</span>";
        }else{
            $shortname = $r->designationshortname;
        }
        ?>
           ...
           <div class="">
               <div class="col-12">
                   <table class="table-bordered">
                       ...
                       <tr class="">
                           <td class="p-1" style="width: 300px;">Department:</td>
                           <td class="p-1"><?php echo $r->designationname?></td>
                       </tr>
                       <tr class="">
                           <td class="p-1">Shortname:</td>
