...
<script>
    ...
    function departmentDetailsView(id) {
        $.ajax({
            type:'post',
            url:'<?= base_url("Department/departmentViewDetails")?>',
            data:{id:id},
            success:function (res) {
                if(res!=false){
                    $('#loadDepartmentDetails').html(res);
                }
            }
        });
    }
