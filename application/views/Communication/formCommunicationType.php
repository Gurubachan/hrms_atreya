        ...
        <div class="box col-md-12">
            <div class="box-inner">
                <div class="box-header well">
                    <h2><i class="fa fa-angle-double-right "></i> Create Communication Type</h2>
                    <div class="box-icon">
                ...
                <div class="box-content">
                    <form  class="" id="communicationTypeForm" autocomplete="off">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="communicationtypename" name="communicationtypename" class="form-control" aria-required="true" aria-invalid="false" onclick="charachters_validate('communicationtypename')" minlength="3" maxlength="20" required placeholder="Enter communication type name">
                ...
                <div class="box-content">
                    <div class="table-responsive">
                        <table class="table  table-striped table-bordered bootstrap-datatable datatable  table-earning">
                            ...
                            <tr>
                                <th>Sl#</th>
                                <th>Communication Type name</th>
                                <th>IsActive</th>
                                <th>Action</th>
                            </tr>
                            </thead>
                            <tbody id="load_communicationtype">
                            </tbody>
                        </table>
                    </div>
                </div>
