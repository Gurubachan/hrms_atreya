        ...
        <div class="box col-md-12">
            <div class="box-inner">
                <div class="box-header well">
                    <h2><i class="fa fa-angle-double-right "></i> Create Religion</h2>
                    <div class="box-icon">
...
<div class="modal fade" id="religionDetials">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header red" style="background-color: cornflowerblue;">
                <h3 class="text-white" style="">Religon Details</h3>
            ...
            <div class="modal-body">
                <div class="form-group">
                    <div class="row">
                        <div class="col-sm-12">
                            <div id="loadReligionDetails"></div>
                        </div>
                    </div>
                </div>
            </div>
