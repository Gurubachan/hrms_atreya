...
create view view_job_posting(id,companyid,companyname,postname,designationid,designationname,nov,
    localtion,jobdescription,experiancename,responsibility,startdate,enddate,qualificationid,
...
alter table tbl_job_posting rename column experiance to experience;
alter table tbl_job_posting rename column jobdescriptiom to jobdescription;
